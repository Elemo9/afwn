...
export default function WelcomeToAFWN() {
  return (
    <div className='h-fit w-full flex items-center py-24'>
        <div className='flex justify-between w-[90%] mx-auto'>
            <div className='flex flex-col gap-6 w-[45%]'>
                <h2 className='text-3xl font-black uppercase tracking-[0.8em] text-yellow-500'>Welcome</h2>
                <h4 className='text-6xl uppercase font-semibold text-white'>Africa Fashion Week Nigeria</h4>
                <p className='text-base  tracking-widest text-white'>The Largest global showcase of emerging African creatives</p>
            </div>

            <div className='flex flex-col gap-8 w-[45%]'>
                <p className='text-sm tracking-widest leading-8 text-white'>African Fashion Week Nigeria (AFWN) is the premier platform celebrating the vibrant world of African fashion. 
                    ...
                    this event bridges tradition and modernity, putting African fashion on the global stage.</p>
                
                <p className='text-sm tracking-widest leading-8 text-white'>
